...
import { t as require_react } from "./react-DBcWLreh.js";
import { t as require_react_dom } from "./react-dom-BXBUVNW_.js";
...
if (process.env.NODE_ENV !== "production") DataRouterContext.displayName = "DataRouter";
var DataRouterStateContext = /* @__PURE__ */ import_react.createContext(null);
if (process.env.NODE_ENV !== "production") DataRouterStateContext.displayName = "DataRouterState";
var AwaitContext = /* @__PURE__ */ import_react.createContext(null);
if (process.env.NODE_ENV !== "production") AwaitContext.displayName = "Await";
/**
...
if (process.env.NODE_ENV !== "production") NavigationContext.displayName = "Navigation";
var LocationContext = /* @__PURE__ */ import_react.createContext(null);
if (process.env.NODE_ENV !== "production") LocationContext.displayName = "Location";
var RouteContext = /* @__PURE__ */ import_react.createContext({
	outlet: null,
	matches: [],
	isDataRoute: false
});
if (process.env.NODE_ENV !== "production") RouteContext.displayName = "Route";
var RouteErrorContext = /* @__PURE__ */ import_react.createContext(null);
if (process.env.NODE_ENV !== "production") RouteErrorContext.displayName = "RouteError";
/**
...
function useHref(to, _temp) {
	...
	!useInRouterContext() && (process.env.NODE_ENV !== "production" ? invariant(false, "useHref() may be used only in the context of a <Router> component.") : invariant(false));
...
function useLocation() {
	!useInRouterContext() && (process.env.NODE_ENV !== "production" ? invariant(false, "useLocation() may be used only in the context of a <Router> component.") : invariant(false));
...
function useMatch(pattern) {
	!useInRouterContext() && (process.env.NODE_ENV !== "production" ? invariant(false, "useMatch() may be used only in the context of a <Router> component.") : invariant(false));
...
function useNavigateUnstable() {
	!useInRouterContext() && (process.env.NODE_ENV !== "production" ? invariant(false, "useNavigate() may be used only in the context of a <Router> component.") : invariant(false));
	...
	return import_react.useCallback(function(to, options) {
		if (options === void 0) options = {};
		process.env.NODE_ENV !== "production" && warning(activeRef.current, navigateEffectWarning);
...
function useRoutesImpl(routes, locationArg, dataRouterState, future) {
	!useInRouterContext() && (process.env.NODE_ENV !== "production" ? invariant(false, "useRoutes() may be used only in the context of a <Router> component.") : invariant(false));
	...
	if (process.env.NODE_ENV !== "production") {
		process.env.NODE_ENV !== "production" && warning(parentRoute || matches != null, "No routes matched location \"" + location.pathname + location.search + location.hash + "\" ");
...
function _renderMatches(matches, parentMatches, dataRouterState, future) {
	...
	if (errors != null) {
		...
		!(errorIndex >= 0) && (process.env.NODE_ENV !== "production" ? invariant(false, "Could not find a matching route for errors on route IDs: " + Object.keys(errors).join(",")) : invariant(false));
...
function useDataRouterContext$1(hookName) {
	...
	!ctx && (process.env.NODE_ENV !== "production" ? invariant(false, getDataRouterConsoleError$1(hookName)) : invariant(false));
	return ctx;
}
function useDataRouterState$1(hookName) {
	let state = import_react.useContext(DataRouterStateContext);
	!state && (process.env.NODE_ENV !== "production" ? invariant(false, getDataRouterConsoleError$1(hookName)) : invariant(false));
	return state;
}
function useRouteContext(hookName) {
	let route = import_react.useContext(RouteContext);
	!route && (process.env.NODE_ENV !== "production" ? invariant(false, getDataRouterConsoleError$1(hookName)) : invariant(false));
	return route;
}
function useCurrentRouteId(hookName) {
	let route = useRouteContext(hookName);
	let thisRoute = route.matches[route.matches.length - 1];
	!thisRoute.route.id && (process.env.NODE_ENV !== "production" ? invariant(false, hookName + " can only be used on routes that contain a unique \"id\"") : invariant(false));
...
function Navigate(_ref4) {
	...
	!useInRouterContext() && (process.env.NODE_ENV !== "production" ? invariant(false, "<Navigate> may be used only in the context of a <Router> component.") : invariant(false));
	let { future, static: isStatic } = import_react.useContext(NavigationContext);
	process.env.NODE_ENV !== "production" && warning(!isStatic, "<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");
	let { matches } = import_react.useContext(RouteContext);
	let { pathname: locationPathname } = useLocation();
...
function Router(_ref5) {
	...
	useInRouterContext() && (process.env.NODE_ENV !== "production" ? invariant(false, "You cannot render a <Router> inside another <Router>. You should never have more than one in your app.") : invariant(false));
	...
	process.env.NODE_ENV !== "production" && warning(locationContext != null, "<Router basename=\"" + basename + "\"> is not able to match the URL " + ("\"" + pathname + search + hash + "\" because it does not start with the ") + "basename, so the <Router> won't render anything.");
...
function createRoutesFromChildren(children, parentPath) {
	...
	import_react.Children.forEach(children, (element, index) => {
		...
		!(element.type === Route) && (process.env.NODE_ENV !== "production" ? invariant(false, "[" + (typeof element.type === "string" ? element.type : element.type.name) + "] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>") : invariant(false));
		!(!element.props.index || !element.props.children) && (process.env.NODE_ENV !== "production" ? invariant(false, "An index route cannot have child routes.") : invariant(false));
		let route = {
...
function mapRouteProperties(route) {
	...
	if (route.Component) {
		if (process.env.NODE_ENV !== "production") {
			if (route.element) process.env.NODE_ENV !== "production" && warning(false, "You should not include both `Component` and `element` on your route - `Component` will be used.");
		}
	...
	if (route.HydrateFallback) {
		if (process.env.NODE_ENV !== "production") {
			if (route.hydrateFallbackElement) process.env.NODE_ENV !== "production" && warning(false, "You should not include both `HydrateFallback` and `hydrateFallbackElement` on your route - `HydrateFallback` will be used.");
		}
		Object.assign(updates, {
	...
	if (route.ErrorBoundary) {
		if (process.env.NODE_ENV !== "production") {
			if (route.errorElement) process.env.NODE_ENV !== "production" && warning(false, "You should not include both `ErrorBoundary` and `errorElement` on your route - `ErrorBoundary` will be used.");
		}
		Object.assign(updates, {
...
function getFormEncType(encType) {
	if (encType != null && !supportedFormEncTypes.has(encType)) {
		process.env.NODE_ENV !== "production" && warning(false, "\"" + encType + "\" is not a valid `encType` for `<Form>`/`<fetcher.Form>` " + ("and will default to \"" + defaultEncType + "\""));
		return null;
	}
	return encType;
}
...
if (process.env.NODE_ENV !== "production") ViewTransitionContext.displayName = "ViewTransition";
var FetchersContext = /* @__PURE__ */ import_react.createContext(/* @__PURE__ */ new Map());
if (process.env.NODE_ENV !== "production") FetchersContext.displayName = "Fetchers";
...
function RouterProvider(_ref) {
	...
	import_react.useEffect(() => {
		process.env.NODE_ENV !== "production" && warning(fallbackElement == null || !router.future.v7_partialHydration, "`<RouterProvider fallbackElement>` is deprecated when using `v7_partialHydration`, use a `HydrateFallback` component instead");
	}, []);
...
if (process.env.NODE_ENV !== "production") HistoryRouter.displayName = "unstable_HistoryRouter";
...
var Link = /* @__PURE__ */ import_react.forwardRef(function LinkWithRef(_ref7, ref) {
	...
	if (typeof to === "string" && ABSOLUTE_URL_REGEX.test(to)) {
		...
		if (isBrowser) try {
			...
			process.env.NODE_ENV !== "production" && warning(false, "<Link to=\"" + to + "\"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.");
		}
	}
...
if (process.env.NODE_ENV !== "production") NavLink.displayName = "NavLink";
/**
...
if (process.env.NODE_ENV !== "production") ScrollRestoration.displayName = "ScrollRestoration";
var DataRouterHook;
...
function useDataRouterContext(hookName) {
	let ctx = import_react.useContext(DataRouterContext);
	!ctx && (process.env.NODE_ENV !== "production" ? invariant(false, getDataRouterConsoleError(hookName)) : invariant(false));
	return ctx;
}
function useDataRouterState(hookName) {
	let state = import_react.useContext(DataRouterStateContext);
	!state && (process.env.NODE_ENV !== "production" ? invariant(false, getDataRouterConsoleError(hookName)) : invariant(false));
	return state;
}
/**
...
function useFormAction(action, _temp2) {
	...
	!routeContext && (process.env.NODE_ENV !== "production" ? invariant(false, "useFormAction must be used inside a RouteContext") : invariant(false));
...
function useFetcher(_temp3) {
	...
	!fetcherData && (process.env.NODE_ENV !== "production" ? invariant(false, "useFetcher must be used inside a FetchersContext") : invariant(false));
	!route && (process.env.NODE_ENV !== "production" ? invariant(false, "useFetcher must be used inside a RouteContext") : invariant(false));
	!(routeId != null) && (process.env.NODE_ENV !== "production" ? invariant(false, "useFetcher can only be used on routes that contain a unique \"id\"") : invariant(false));
	...
	let load = import_react.useCallback((href, opts) => {
		!routeId && (process.env.NODE_ENV !== "production" ? invariant(false, "No routeId available for fetcher.load()") : invariant(false));
	...
	let FetcherForm = import_react.useMemo(() => {
		...
		if (process.env.NODE_ENV !== "production") FetcherForm.displayName = "fetcher.Form";
		return FetcherForm;
	}, [fetcherKey]);
...
function useScrollRestoration(_temp4) {
	...
	usePageHide(import_react.useCallback(() => {
		...
		try {
			...
			process.env.NODE_ENV !== "production" && warning(false, "Failed to save scroll positions in sessionStorage, <ScrollRestoration /> will not work properly (" + error + ").");
		}
		window.history.scrollRestoration = "auto";
	}, [
		storageKey,
...
function useViewTransitionState(to, opts) {
	...
	!(vtContext != null) && (process.env.NODE_ENV !== "production" ? invariant(false, "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?") : invariant(false));
